  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-neutral-900">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <p className="anim-fade-up delay-200 text-gray-400 dark:text-gray-500 mb-8 text-sm">
        ...
        {/* Email form */}
        <form onSubmit={handleLogin} className="anim-fade-up delay-350 w-full max-w-sm space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-neutral-700 bg-gray-50 dark:bg-neutral-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm transition-shadow"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 px-4 bg-emerald-500 hover:bg-emerald-600 active:bg-emerald-700 disabled:bg-emerald-300 text-white font-semibold rounded-xl transition-all haptic"
          >
            {loading ? (
        ...
        <p className="anim-fade-up delay-400 mt-7 text-sm text-gray-400 dark:text-gray-500">
          ...
          <Link href="/register" className="text-emerald-500 font-semibold hover:text-emerald-600 transition-colors">
            Sign up
          </Link>
        </p>
      </div>
