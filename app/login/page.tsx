...
function LoginInner() {
  ...
  return (
    <div className="flex flex-col h-full gradient-bg relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-20%] w-[300px] h-[300px] bg-emerald-400/20 dark:bg-emerald-600/20 rounded-full blur-[80px] pointer-events-none anim-float"></div>
      <div className="absolute bottom-[-10%] right-[-20%] w-[300px] h-[300px] bg-teal-400/20 dark:bg-teal-600/20 rounded-full blur-[80px] pointer-events-none anim-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative z-10">
        ...
        <div className="anim-fade-up delay-150 flex items-baseline gap-1.5 mb-1">
          <span className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">GroupTab</span>
        </div>
        <p className="anim-fade-up delay-200 text-gray-500 dark:text-gray-400 mb-8 text-sm font-medium">
        ...
        <p className="anim-fade-up delay-300 mt-8 text-[15px] font-medium text-gray-500 dark:text-gray-400">
          ...
          <Link href="/register" className="text-emerald-600 dark:text-emerald-400 font-bold hover:text-emerald-500 transition-colors">
            Sign up
          </Link>
        </p>
      </div>
